    ...
    <div class="wrapper">
      <div class="container">
        <div class="order-wrap">
          <div class="item-order">
            ...
            <div class="order-info">
              ...
              <p>收货信息：洪先生 138****5212 广东省 深圳市 南山区 西丽街道 茶光村</p>
            </div>
        ...
        <div class="item-pay">
          ...
          <div class="pay-way">
            <p>支付平台</p>
            <div class="pay pay-ali" @click="payWay(0)" :class="index === 0?'checked':''"></div>
            <div class="pay pay-wechat" @click="payWay(1)" :class="index === 1?'checked':''"></div>
          </div>
        </div>
      </div>
    </div>
