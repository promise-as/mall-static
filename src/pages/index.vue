          ...
          <ul class="menu-wrap">
            <li class="menu-item">
              ...
              <div class="children">
                <ul>
                  <li>
                    <a href="" id=""><img src="/imgs/item-box-1.png" alt="">小米8</a>
                  </li>
                </ul>
                <ul>
                  <li>
                    <a href="" id=""><img src="/imgs/item-box-1.png" alt="">小米CC9</a>
                  </li>
                </ul>
                <ul>
                  <li>
                    <a href="" id=""><img src="/imgs/item-box-1.png" alt="">小米CC9美图定制版</a>
                  </li>
                </ul>
                <ul>
                  <li>
